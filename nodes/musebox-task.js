...
(function(global) {
	...
	/* FRAME */
	function Frame(){
		this.addOutput("frame", "frame");		
	}
    Frame.title = "Frame";
    Frame.desc = "Single frame obtained by external stream";
	Frame.prototype.onExecute = function() {
    };
    LiteGraph.registerNodeType("MuseBox Tasks/Frame", Frame);
